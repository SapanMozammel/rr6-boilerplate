...
const Auth = () => {
  return (
    <div className="relative flex justify-center md:px-12 lg:px-0 min-h-screen">
      <div className="relative z-10 flex flex-1 flex-col bg-white py-10 px-6 shadow-2xl justify-center sm:flex-none sm:px-16 w-full sm:w-3/4 lg:w-1/2">
      ...
      <div className="hidden sm:contents lg:relative lg:block lg:flex-1">
        <img
          alt=""
          src="https://images.pexels.com/photos/7534801/pexels-photo-7534801.jpeg?auto=compress&cs=tinysrgb&w=1600"
          width="1664"
          height="1866"
          decoding="async"
          data-nimg="1"
